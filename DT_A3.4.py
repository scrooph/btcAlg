...
PARAMS = {
    "start_time": "2017-09-04 21:00:00",  # 回测起始时间
    "end_time": "2017-09-06 06:00:00",  # 回测结束时间
...
def initialize(context):
    ...
    context.user_data.portfolio_cbrate = 0.09
...
def handle_data(context):
    ...
    if portfolio_rate < (context.user_data.portfolio_high - context.user_data.portfolio_cbrate) and portfolio_rate > context.user_data.portfolio_bottom:
        context.user_data.portfolio_rand = context.user_data.portfolio_rand + 1
        if ar < context.user_data.over_sell:
            ...
            if context.user_data.portfolio_rand < context.user_data.portfolio_level or his_bound > latest_close_price:
                ...
                context.user_data.portfolio_cbrate = context.user_data.portfolio_cbrate * 1.8
                context.user_data.portfolio_rand = 0
    ...
    if context.user_data.botoom_price > 0:
        ...
        if latest_close_price > context.user_data.botoom_price*(1+context.user_data.botoom_prate):
            ...
            if botoom_amount > HUOBI_CNY_LTC_MIN_ORDER_QUANTITY:
    ...
    if context.user_data.randlock:
        ...
        if context.user_data.randlock_up < context.user_data.randlevel or his_bound > latest_close_price:
            #AR 抄底
            if ar < context.user_data.over_sell:
                setbprice(context, latest_close_price)
